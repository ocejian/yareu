...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", 366386651).split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/ofckelrapillas"
)  # Example:- https://t.me/akaChampu
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/storetelekram"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/kelra/KelraMusic")
